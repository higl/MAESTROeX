...
#endif
       w0, &
       dx,dt,adv_bc,phys_bc) bind(C,name="mkutrans")
          ...
          do j=lo(2),hi(2)
             do i=lo(1),hi(1)
                ...
                if (i .eq. lo(1) .and. lo(1) .eq. domlo(1)) then
                   ...
                   case  default
#ifndef AMREX_USE_CUDA
                      call amrex_error("mkutrans: invalid boundary type phys_bc(1,1)")
#endif
                   end select
                end if
                ...
                if (i .eq. hi(1) .and. hi(1)-1 .eq. domhi(1)) then
                   ...
                   case  default
#ifndef AMREX_USE_CUDA
                      call amrex_error("mkutrans: invalid boundary type phys_bc(1,2)")
#endif
                   end select
                end if
          ...
          do j=lo(2),hi(2)
             do i=lo(1),hi(1)
                ...
                if (j .eq. lo(2) .and. lo(2) .eq. domlo(2)) then
                   ...
                   case  default
#ifndef AMREX_USE_CUDA
                      call amrex_error("mkutrans: invalid boundary type phys_bc(2,1)")
#endif
                   end select
                end if
                ...
                if (j .eq. hi(2) .and. hi(2)-1 .eq. domhi(2)) then
                   ...
                   case  default
#ifndef AMREX_USE_CUDA
                      call amrex_error("mkutrans: invalid boundary type phys_bc(2,2)")
#endif
                   end select
                end if
          ...
          do j=lo(2),hi(2)
             do i=lo(1),hi(1)
                ...
                if (k .eq. lo(3) .and. lo(3) .eq. domlo(3)) then
                   ...
                   case  default
#ifndef AMREX_USE_CUDA
                      call amrex_error("mkutrans: invalid boundary type phys_bc(3,1)")
#endif
                   end select
                end if
                ...
                if (k .eq. hi(3) .and. hi(3)-1 .eq. domhi(3)) then
                   ...
                   case  default
#ifndef AMREX_USE_CUDA
                      call amrex_error("mkutrans: invalid boundary type phys_bc(3,2)")
#endif
                   end select
                end if
